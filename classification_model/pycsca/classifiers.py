...
custom_dict = {RandomClassifier.__name__: 0,
               LogisticRegression.__name__: 1,
               Perceptron.__name__: 2,
               SGDClassifier.__name__: 3,
               RidgeClassifier.__name__: 4,
               LinearSVC.__name__: 5,
               DecisionTreeClassifier.__name__: 6,
               ExtraTreeClassifier.__name__: 7,
               RandomForestClassifier.__name__: 8,
               AdaBoostClassifier.__name__: 9,
               GradientBoostingClassifier.__name__: 10,
               HistGradientBoostingClassifier.__name__: 11
               }
classifiers_space = [(RandomClassifier, {}, {})]
...
params = dict(loss='auto', learning_rate=0.1, max_iter=100, max_leaf_nodes=31, max_depth=None, min_samples_leaf=20,
              ...
              n_iter_no_change=10, tol=0.001, early_stopping=True, verbose=0, random_state=None)
...
params = dict(penalty='l2', dual=False, tol=0.0001, C=1.0, fit_intercept=True, intercept_scaling=1,
              class_weight=None, random_state=None, solver='lbfgs', max_iter=500, multi_class='auto', verbose=0,
...
clf = RidgeClassifier
params = dict(alpha=1.0, fit_intercept=True, normalize=False, copy_X=True, max_iter=None, tol=1e-3, class_weight=None,
...
clf = LinearSVC
params = dict(penalty='l2', loss='squared_hinge', dual=True, tol=1e-4, C=1.0, multi_class='ovr', fit_intercept=True,
