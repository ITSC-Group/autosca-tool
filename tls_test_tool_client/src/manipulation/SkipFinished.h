 ...
 */
#ifndef MANIPULATION_SKIPFINISHED_H_
#define MANIPULATION_SKIPFINISHED_H_

#include "Manipulation.h"

namespace TlsTestTool {
/**
 * Skip sending a Finished message.
 */
class SkipFinished : public Manipulation {
public:
...
#endif /* MANIPULATION_SKIPFINISHED_H_ */
